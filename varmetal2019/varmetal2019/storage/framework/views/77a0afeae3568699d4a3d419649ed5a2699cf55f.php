...
<head>
    ...
    <!--Rut Formater-->
    <script src=<?php echo e(asset("js/jquery.rut.js")); ?>></script>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">Varmetal</a>
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="<?php echo e(url('/')); ?>">Varmetal</a>
                                ...
                                <?php else: ?>
                                  <a class="dropdown-item" href="<?php echo e(url('/homepage/Trabajador')); ?>">
                                      Detalles Cuenta
                                  </a>
                                <?php endif; ?>
                                <a class="dropdown-item" href="<?php echo e(url('/contrasena')); ?>">Cambiar Contraseña</a>
                                <div class="dropdown-divider"></div>
