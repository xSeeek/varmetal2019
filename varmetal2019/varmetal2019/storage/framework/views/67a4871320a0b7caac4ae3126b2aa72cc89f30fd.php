    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <h5>
                        ...
                        <b>RUT:</b>
                        <div class="col-sm-10">
                            <input type="text" readonly id="rutTrabajador" class="form-control-plaintext" value="<?php echo e($trabajador->rut); ?>">
                        </div>
                        <b>Estado:</b>
                        <div class="col-sm-10">
                        <?php if($trabajador->rut == true): ?>
                    ...
                    <h5>
                        <b>Correo:</b>
                        <div class="col-sm-10">
                            <input type="email" class="form-control-plaintext" readonly id="correoTrabajador" value="<?php echo e($usuario_trabajador->email); ?>">
                        </div>
                    </h5>
                    <br>
            ...
            <div class="card">
                ...
                <?php if(($productos_trabajador != NULL) && (count($productos_trabajador)>0)): ?>
                <table id="tablaAdministracion" style="width:100%" align="center">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $productos_trabajador; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $productos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="id_productoTrabajador<?php echo e($productos->idProductos); ?>">
                                <td scope="col"><?php echo e($productos->nombre); ?></td>
                                <td scope="col"><?php echo e($productos->fechaInicio); ?></td>
                                <?php if($productos->fechaFin != NULL): ?>
                                    <td scope="col"><?php echo e($productos->fechaFin); ?></td>
                                <?php else: ?>
                                    <td scope="col">No determinada</td>
                                <?php endif; ?>
                                <?php switch($productos->estado):
                                    case (0): ?>
                                    ...
                                    <?php default: ?>
                                        ...
                                        <?php break; ?>
                                <?php endswitch; ?>
                                <td scope="col"><?php echo e($productos->pesoKg); ?></td>
                                <td scope="col"><a class="btn btn-outline-secondary btn-sm" onclick="deleteProducto(<?php echo e($trabajador->idTrabajador); ?>, <?php echo e($productos->idProducto); ?>)" role="button"><b>Eliminar</b></a>
                            </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" align="center">
                ...
                <h5>
                    Borrar Trabajador:
                <br>
                    <a class="btn btn-outline-success btn-md" role="button" onclick="deleteTrabajador(<?php echo e($trabajador->idTrabajador); ?>)">Borrar</a>
                </h5>
                <br>
                <h5>
                    Asignar nuevos productos:
                <br>
                    <a class="btn btn-outline-success btn-md" id="deleteButton" role="button" href="<?php echo e(url('trabajador/asignarProducto', [$trabajador->idTrabajador])); ?>">Asignar</a>
                </h5>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function deleteTrabajador(data)
    {
        $.ajax({
            ...
            type: "POST",
            data: {DATA:data},
            url: "<?php echo e(url('/trabajadorControl/deleteTrabajador')); ?>",
    ...
    function deleteProducto(idTrabajador, idProducto)
    {
        ...
        $.ajax({
            ...
            success: function(response){
                console.log('asd');
                window.location.href = "<?php echo e(url('trabajadorControl', [$trabajador->idTrabajador])); ?>";
            }
        });
    }
</script>
